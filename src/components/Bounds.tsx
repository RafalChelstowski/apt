...
function CubeBoundary({ mesh }: { mesh: THREE.Mesh }) {
  ...
  return (
    <mesh name='static-cube' ref={ref} geometry={geometry} material={material} scale={scale} />
  );
}
...
function CylinderBoundary({ mesh }: { mesh: THREE.Mesh }) {
  ...
  return (
    <mesh name='static-cylinder' ref={ref} geometry={geometry} material={material} scale={scale} />
  );
}
